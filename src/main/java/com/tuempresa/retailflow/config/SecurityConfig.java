...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/auth/login", "/auth/register", "/error", "/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {  // ✅ Agregado para CORS
        ...
        config.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:5174","http://localhost:5173")); // Frontend permitido
