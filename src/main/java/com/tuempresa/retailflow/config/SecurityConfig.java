...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {  // ✅ Agregado para CORS
        ...
        config.setAllowedOrigins(List.of("http://localhost:3000", "http://localhost:5174","http://localhost:5173","http://149.50.150.130", "http://149.50.150.130:3000", "http://codigoabierto.online")); // Frontend permitido
